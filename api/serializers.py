...
def getLocationDetails(long, lat):
    ...
    locationDict = {'loc_long': 19.04821,
                    'loc_lat': 72.90946,
                    'loc_display_name': "Mahavir Education Trust Chowk, W.T Patil Marg, D P Rd, next to Duke's Company, Chembur, Mumbai, Maharashtra 400088",
                    'loc_suburb': "Chembur",
                    'loc_city': "Mumbai",
                    'loc_municipality': "Mumbai Metropolitan Region",
                    'loc_state_distric': "Mumbai",
